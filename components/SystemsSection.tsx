...
const Card: React.FC<CardProps> = ({ icon, badge, title, body, features, pricing, pricingSub, cta, accentVar, index, onCta }) => (
  <motion.div
    ...
    className="h-full"
  >
    <SpotlightCard className="h-full rounded-2xl border border-white/[0.07] bg-[var(--surface-2)] p-8 flex flex-col group hover:border-[var(--glacier)]/20 transition-colors duration-300">
      <div className="flex items-start justify-between mb-10">
        <div
          className="w-14 h-14 rounded-xl border border-white/[0.08] bg-[var(--surface-1)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300"
      ...
      <div className="mt-auto">
        <div className="flex items-baseline gap-2 mb-6 pb-6 border-b border-white/[0.06]">
          <span className="font-heading text-2xl font-bold text-white">{pricing}</span>
