...
let fontCache: Promise<
  { name: string; data: ArrayBuffer; weight: 400 | 500 | 600; style: "normal" | "italic" }[]
> | null = null;
...
function loadFonts() {
  fontCache ??= Promise.all([
    ...
    { name: "Archivo", data: toArrayBuffer(archivo), weight: 600 as const, style: "normal" as const },
    { name: "Plex Mono", data: toArrayBuffer(mono), weight: 500 as const, style: "normal" as const },
    { name: "Newsreader", data: toArrayBuffer(newsreader), weight: 400 as const, style: "italic" as const },
  ]);
  return fontCache;
}
...
export async function GET(request: Request) {
  ...
  const title = clean(params.get("title"), 130) || "The systems behind growing businesses.";
    ...
    (
      ...
      >
        ...
        >
          ...
          <svg width={82} height={82} viewBox="0 0 100 100" fill={GLACIER} fillRule="evenodd">
